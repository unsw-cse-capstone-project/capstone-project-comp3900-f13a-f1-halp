...
def createAuction():
    ...
    if form.validate_on_submit():
        ...
        auctionDetails = AuctionDetails(PropertyID = PropertyID_, SellerID = current_user.login_name, AuctionStart = form.auctionStart.data, AuctionEnd = form.auctionEnd.data, 
