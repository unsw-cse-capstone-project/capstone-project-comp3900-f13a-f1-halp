from server_user import app, db, User, BankDetails, login_manager
...
def signup():
    try:
        ...
        new_user = User(id=login_name, password=password_1, address=address, date_of_birth= date(2000,12,12))
